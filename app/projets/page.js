...
const PROJECTS_DATA = [
  {
    ...
    images: [
      ...
      '/images/express_sale/express_sale_ticket.jpeg',
  ...
  },
  {
    ...
    statusLabel: { fr: 'En production', en: 'Live' },
    year: '2024–2025',
    tech: ['Mobile', 'QR Code', 'Traçabilité'],
    stats: [
      { value: '7+', label: { fr: 'Écrans', en: 'Screens' } },
      { value: 'QR', label: { fr: 'Traçabilité', en: 'Traceability' } },
      { value: '3', label: { fr: 'Rôles', en: 'Roles' } },
    ],
    gradient: 'linear-gradient(135deg, #0a0a0a 0%, #2f2a1a 50%, #0a0a0a 100%)',
    accentColor: '#fbbf24',
    ...
    images: [
      ...
      '/images/soaharilandy/soa4.jpeg',
      '/images/soaharilandy/soa5.jpeg',
      '/images/soaharilandy/soa6.jpeg',
    ],
  },
];
